            ...
            <div class="mx-auto max-w-full">
                ...
                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 lg:gap-[35px]">
                    <article v-for="product in featuredItems" :key="product.id" class="group relative flex flex-col overflow-hidden bg-cocov-card">
                        ...
                        <div class="relative flex min-h-[102px] flex-col px-4 pt-4 pb-4">
                            ...
                            <button
                                type="button"
                                class="absolute inset-x-0 bottom-0 flex h-9 translate-y-full items-center justify-center gap-2 bg-cocov-gold text-[13px] capitalize text-white opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100"
                                @click="addToCart(product.id)"
                            ><ShoppingBagIcon class="h-4 w-4" /> Add to cart</button>
                        </div>
                    </article>
                </div>
